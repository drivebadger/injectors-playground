...
# This is an injector script. It will be run against all VeraCrypt-encrypted
...
#
#
# If you want to match a specific VeraCrypt partition, instead of executing
# such code on all partitions, you have 2 options:
#
# 1. Rename directory with this script from "veracrypt" to "veracrypt-P02012407007",
...
# is not possible for VeraCrypt.

base=$1

if [ -d "$base/Users" ] && [ ! -f "$base/Users/drivebadger.txt" ]; then
	echo "This is a test message from Drive Badger VeraCrypt generic injector." >"$base/Users/drivebadger.txt"
fi
